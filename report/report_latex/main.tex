...
\hline \multicolumn{2}{|l|}{\textbf{National Performance}} & \textbf{Rank: 123/228} & \textbf{National Average: \textsterling 30,026} & \textbf{Difference: -\textsterling 21,669} \\
\hline
\end{tabular}
}
...
With a total income of \textsterling 656,869 from all categories, Durham ranked second overall in the North East, behind Newcastle University (\textsterling 1,868,311). It outperformed Teesside (\textsterling 277,932), Northumbria (\textsterling 271,526), and Sunderland (\textsterling 72,033), reaffirming its position as a top-tier institution in the region.

The breakdown of income shows that business services remains Durham's largest revenue source at 63.7\% (\textsterling 418,390), followed by research (33.0\% or \textsterling 216,850), regeneration and development (2.0\% or \textsterling 13,272), and CPD and continuing education (1.3\% or \textsterling 8,357). This indicates a diverse yet business-focused funding profile.
...
Durham generated a total of \textsterling 6,687 in IP-related income, with \textsterling 517 from non-software licenses, \textsterling 49 from software licenses, and \textsterling 160 from other IP sources. These figures reflect minimal financial return from the university's IP assets.

Income by client type showed that SMEs contributed \pounds 458, followed by other commercial businesses (\pounds 163) and non-commercial organizations (\textsterling 105), indicating generally low monetization across all sectors. In the North East, Durham ranked second in IP income, behind Newcastle University (\textsterling 36,868), and held the 34th position nationally out of 228 universities.
...
\hline Newcastle University & \textsterling 117.35 & \textsterling 64.44 & \textsterling 3.02 \\
\hline Teesside University & \textsterling 46.53 & \textsterling 43.84 & \textsterling 0.01 \\
\hline University of Northumbria at Newcastle & \textsterling 39.21 & \textsterling 13.78 & \textsterling 0.11 \\
\hline University of Durham & \textsterling 19.76 & \textsterling 27.73 & \textsterling 0.44 \\
...
\hline Newcastle University & 0.125 & \textsterling 122,812 & \textsterling 15,351 \\
\hline University of Durham & 0.324 & \textsterling 24,094 & \textsterling 7,806 \\
...
\hline Teesside University & 0.937 & \textsterling 7,649 & \textsterling 7,170 \\
\hline
\end{tabular}
}
...
The income analysis reveals Durham University's strong performance in business services income, ranking 31st nationally with a total of \textsterling 418,390. The university demonstrates a well-diversified income portfolio, with significant contributions from business services and collaborative research. While business services income shows consistent performance, research income has shown some volatility, and CPD income, despite high learner engagement (98,190 learner days), generates relatively low revenue (\textsterling 8,357). The university's total income of \textsterling 656,869 positions it second in the North East region, indicating a solid financial foundation but with room for improvement in commercial activities.
...
\hline \multicolumn{5}{|l|}{\textbf{Income Analysis (Section 5.2)}} \\
...
\hline Durham Business Services Income & £418,390 & 31/228 & 2.income\_analysis.py & table-2a.csv \\
\hline National Average Business Services & £205,673 & - & 2.income\_analysis.py & table-2a.csv \\
...
\hline Durham Total Income & £656,869 & 2/5 (Regional) & 2.income\_analysis.py & Multiple tables \\
\hline \multicolumn{5}{|l|}{\textbf{Intellectual Property Analysis (Section 5.3)}} \\
